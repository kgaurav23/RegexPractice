...
fun main() {
    ...
    val inputFileName = "input/regex15.txt"
    // Create a Pattern object
    val r = Pattern.compile(REGEX_PATTERN)

    val text = readFileAsLinesUsingBufferedReader15(inputFileName)
    for (line in text) {
...
fun readFileAsLinesUsingBufferedReader15(fileName: String): List<String> = File(fileName).bufferedReader().readLines()