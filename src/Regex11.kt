...
fun main() {
    ...
    val text = readFileAsLinesUsingBufferedReader11(inputFileName)
    for (line in text) {
...
fun readFileAsLinesUsingBufferedReader11(fileName: String): List<String> = File(fileName).bufferedReader().readLines()